...
const FindRide = ({ find, setFind }) => {
  ...
  useEffect(() => {
    setTimeout(() => navigate("/ride/driver-arriving/"), 3000);
  }, []);

  const [isOpen, setIsOpen] = useState(false);
  return (
    <div className="w-screen h-screen fixed top-0 left-0 bg-black/40 flex items-center flex-col gap-5 justify-center">
      <div className="w-full lg:w-[30rem] p-10 h-auto bg-white rounded-3xl flex items-center flex-col gap-5 justify-center">
